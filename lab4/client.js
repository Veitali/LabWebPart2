...
function addUserClick(){
    if(selectedItem != undefined){
        selectedItem.name = document.getElementById('inptName').value;
        selectedItem.age = document.getElementById('inptAge').value;
...
function updateUser(id){
    ...
    if(res != undefined){
        ...
        document.getElementById('inptName').value = selectedItem.name;
        document.getElementById('inptAge').value = selectedItem.age;
